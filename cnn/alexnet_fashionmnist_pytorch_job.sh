...
#SBATCH --output=alexnet_fashionmnist_pytorch.out
#SBATCH --error=alexnet_fashionmnist_pytorch.err
...
# python /data/home/ss231/computer-vision-python/alexnet_fashionmnist_pytorch.py \
#    --use_tensorboard \
#    --use_gpu \
#    --epochs 100 \
#    --optimizer adam
