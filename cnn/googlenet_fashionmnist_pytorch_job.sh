...
#SBATCH --output=googlenet_fashionmnist_pytorch.out
#SBATCH --error=googlenet_fashionmnist_pytorch.err
...
python /data/home/ss231/computer-vision-python/googlenet_fashionmnist_pytorch.py \
    --use_tensorboard \
    --use_gpu \
    --epochs 100 \
    --optimizer adam
