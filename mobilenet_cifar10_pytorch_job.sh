...
#SBATCH --output=mobilenet_cifar10_pytorch.out
#SBATCH --error=mobilenet_cifar10_pytorch.err
...
python /data/home/ss231/computer-vision-python/mobilenet_cifar10_pytorch.py \
    --use_tensorboard \
    --use_gpu \
    --epochs 100 \
    --optimizer sgd
